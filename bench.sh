...
$BIN -i "$INPUT" grayscale \
  | $BIN curve --darks=20 --middarks=-10 --midhighlights=15 --highlights=-10 \
  | $BIN color-grade --shadows-hue=30 --shadows-sat=40 --highlights-hue=220 --highlights-sat=20 \
  | $BIN vignette --amount -60 --feather 70 -o "$OUTPUT"
